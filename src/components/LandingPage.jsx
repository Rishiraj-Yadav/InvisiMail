    ...
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-[#6366F1]/50 selection:text-foreground relative">
      ...
      >
        <div className="px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/register" className="bg-foreground text-background px-6 py-2.5 rounded-full text-sm font-semibold hover:scale-105 transition-transform active:scale-95">
              Get Started
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 w-full relative z-20 flex flex-col lg:flex-row items-center pointer-events-none mt-20 lg:mt-0 gap-12">
          ...
          <div className="w-full lg:w-[50%] flex flex-col items-start text-left mt-12 lg:mt-0">
            ...
            <motion.div 
              ...
              className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-border bg-foreground/5 backdrop-blur-md mb-8"
            >
            ...
            >
              <form onSubmit={handleDemoGenerate} className="relative flex items-center w-full group">
                ...
                <button 
                  ...
                  className="absolute right-2 top-2 bottom-2 bg-foreground text-background font-medium px-6 rounded-full transition-all hover:opacity-90 active:scale-95 flex items-center justify-center text-sm disabled:opacity-80"
                >
              ...
              {demoStatus === 'idle' && (
                <div className="flex gap-4 items-center mt-2">
                  <Link href="/register" className="bg-foreground text-background font-medium px-8 py-3.5 rounded-full transition-all hover:opacity-90 active:scale-95 flex items-center gap-2 text-sm group/btn">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between opacity-60 transition-colors hover:bg-card p-2 -mx-2 rounded-xl">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      <div className="text-sm font-medium text-muted-foreground tracking-wide line-through decoration-foreground/20">shady-site@invisimail.com</div>
                      <div className="text-xs text-muted-foreground flex items-center gap-1.5 mt-1">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="w-full lg:w-[50%] flex flex-col justify-center">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-border bg-foreground/5 backdrop-blur-md mb-8 self-start">
      ...
      <section id="how-it-works" className="py-40 bg-card border-y border-border overflow-hidden">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            {/* The main track line */}
            <div className="absolute top-6 left-0 w-full h-[1px] bg-foreground/5 hidden md:block" />
              ...
              {[
                ...
                <div key={i} className="group flex flex-col items-center text-center cursor-default">
                  ...
                  <div className="w-12 h-12 rounded-xl bg-background border border-border flex items-center justify-center mb-8 relative transition-all duration-300">
                     ...
                     {i !== 3 && <div className="absolute top-[3.5rem] left-1/2 -translate-x-1/2 w-[1px] h-16 bg-foreground/5 md:hidden" />}
                  </div>
          ...
          <div className="flex flex-1 overflow-hidden">
            ...
            <div className="w-64 border-r border-border p-6 hidden md:flex flex-col gap-8 bg-background">
              ...
              <div className="flex flex-col gap-2">
                <div className="px-4 py-2.5 bg-foreground/10 rounded-lg text-sm font-medium text-foreground border border-border">Aliases</div>
            ...
            <div className="flex-1 p-8 flex flex-col gap-8 bg-background">
              <div className="flex justify-between items-center">
                ...
                <button className="bg-foreground text-background px-4 py-2 rounded-lg text-sm font-medium hover:opacity-90 transition-all">New Alias</button>
              </div>
      ...
      <section className="py-40 max-w-5xl mx-auto px-6 text-center">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
          <Link href="/register" className="inline-block bg-foreground text-background font-medium px-10 py-4 rounded-full transition-all hover:opacity-90 active:scale-95 text-lg">
            Get Started
          </Link>
        </motion.div>
      </section>
